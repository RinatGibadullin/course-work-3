...
export class BaseRepository<Entity extends {} = {}, EntityMeta extends {} = {}> {
  ...
  public delete(entity: Entity): Promise<void> {
    if (this.isEntityNew(entity)) {
      throw (new Error('BaseRepository#delete(): you can not delete a new entity'));
    }
  ...
  protected async processResponse(response: any): Promise<Entity | ArrayMeta<Entity, EntityMeta> | null> {
